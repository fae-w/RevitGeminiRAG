# Purpose: This script extracts floor information, including type, level, and area, and exports it to a CSV format.
...
if processed_count > 0:
    ...
    export_data_string = "\n".join(csv_lines)
    suggested_filename = 'project_floors_areas.csv'
    file_format = 'CSV'
