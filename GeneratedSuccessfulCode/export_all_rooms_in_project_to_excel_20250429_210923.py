                 ...
                 if storage_type == System.StorageType.Double:
                     ...
                     val_str = str(param.AsInteger())
                      ...
                      if element_id is not None and element_id != ElementId.InvalidElementId:
                          ...
                          val_str = elem.Name if elem else element_id.ToString() # Try to get name if element exists
                      else:
                          val_str = default
                 else:
    ...
    if isinstance(element, Room):
        ...
        try:
            ...
            if area_internal > 1e-9:
                ...
                if volume_internal is not None and abs(volume_internal) > 1e-9:
