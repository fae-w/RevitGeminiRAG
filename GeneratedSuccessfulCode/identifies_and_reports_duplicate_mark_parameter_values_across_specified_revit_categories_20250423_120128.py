# Purpose: This script identifies and reports duplicate 'Mark' parameter values across specified Revit categories.
...
# from System.Collections.Generic import List, Dictionary # Not strictly necessary here
        ...
        try:
            ...
            if mark_param and mark_param.HasValue:
                ...
                if mark_value and mark_value.strip(): # Check for null, empty or whitespace only string
                    ...
                    if element.Category and hasattr(element.Category, 'Name'):
