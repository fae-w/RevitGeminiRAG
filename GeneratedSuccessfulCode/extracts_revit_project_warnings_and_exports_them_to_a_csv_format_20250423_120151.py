# Purpose: This script extracts Revit project warnings and exports them to a CSV format.
...
try:
    ...
    print("# Error retrieving warnings from the document: {}".format(e))
    ...
    for warning in warnings:
        if isinstance(warning, FailureMessage):
            try:
                ...
                # print("# Error processing warning: {}".format(e))
                try:
