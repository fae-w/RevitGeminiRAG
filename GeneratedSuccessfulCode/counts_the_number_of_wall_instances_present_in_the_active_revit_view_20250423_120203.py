# Purpose: This script counts the number of wall instances present in the active Revit view.
...
if active_view:
    ...
    # Print the result using standard format method
    print("There are {} walls in the current view.".format(wall_count))
else:
