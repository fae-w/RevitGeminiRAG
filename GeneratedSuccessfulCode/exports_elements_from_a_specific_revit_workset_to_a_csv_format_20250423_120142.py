# Purpose: This script exports elements from a specific Revit workset to a CSV format.
...
import System # For String.IsNullOrEmpty
                ...
                try:
                    ...
                    if type_id is not None and type_id != ElementId.InvalidElementId:
                        ...
                        if elem_type is not None and isinstance(elem_type, ElementType):
                         ...
                         type_name = "(No Type ID / System Family Instance)"
