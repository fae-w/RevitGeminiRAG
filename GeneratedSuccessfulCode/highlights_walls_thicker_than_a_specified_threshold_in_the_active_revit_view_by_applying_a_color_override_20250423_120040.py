# Purpose: This script highlights walls thicker than a specified threshold in the active Revit view by applying a color override.
...
if not active_view or not isinstance(active_view, View) or active_view.IsTemplate:
    ...
    if solid_pattern_id == ElementId.InvalidElementId and solid_fill_elements:
        ...
        # print("# Debug: Using a non-Drafting solid fill pattern as fallback.") # Escaped Optional debug
    ...
    if solid_pattern_id != ElementId.InvalidElementId:
        ...
        # Optionally, we could override projection lines too for better visibility if needed.
